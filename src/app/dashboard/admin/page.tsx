...
export default async function AdminDashboard() {
  ...
  const cards = [
    ...
    {
      title: "Inspector Corner",
      description: "Requests, flags, disputes, Master Inspectors, and revenue for the inspector program.",
      href: "/dashboard/admin/inspector-corner",
      stat: (inspectorCount ?? 0) + (flaggedInspectorCount ?? 0) + (openDisputeCount ?? 0),
      statLabel: "items needing attention",
      accent: (inspectorCount ?? 0) + (flaggedInspectorCount ?? 0) + (openDisputeCount ?? 0) > 0 ? "var(--camo-accent)" : "var(--camo-gunmetal)",
    },
    {
