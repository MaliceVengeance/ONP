...
export const metadata = buildPageMetadata({
  title: "Contractor Directory | Our Next Project",
  description:
    "Explore contractor profiles on ONP and review available credentials, service information, and project experience before deciding who fits your project.",
  path: "/contractors",
});
